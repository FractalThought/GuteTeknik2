...
Här följer några idéer på projekt som ni kan göra:
# What to watch?
...
# Galleri med filtrering

Ett galleri av något (bilder, karaktärer, produkter) som kan filtreras utifrån egenskap. Till exempel fritext, kategori, pris.
...
Låter användaren skriva in händelser (namn och datum) och visa dessa i ett årshjul.

# NPC generator

Låt användaren fylla i valfritt några attribut, till exempel ras, klass, location. Generera sedan en NPC (non player character) som slumpar fram en bakgrund utifrån det du ger och slumpar de saker du inte valt.

Exempel på saker som kan slumpas:
-  Alignment (Chaotic, Neutral, Lawful och Good, Neutral, Evil - tänk på att om Neutral Neutral genereras så bör det stå "True Neutral").
- Location/Origin
- Motivation
- Occupation

Bonus: Skapa mer algoritmbaserad generering. Till exempel begränsa vilket jobb en NPC kan ha utifrån vilken plats NPCn är på.