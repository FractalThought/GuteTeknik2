...
let manipulatedMessage = myMessage.substring(7, 13);
...
```javascript
let myMessage = "Alfred gillar kexchoklad";
let manipulatedMessage = myMessage.slice(0, 17); // Observera att i programmering börjar man alltid räkna från 0
...
let myName = "Felix";
let funName = myName.replace("e", "i");
console.log(funName); // Skriver ut Filix

let inputName = "Aarnold Abrahamsson";
let inputFunName = replaceAll("a", "i");
console.log(inputFunName); // Skriver ut Airnold Abrihimsson
