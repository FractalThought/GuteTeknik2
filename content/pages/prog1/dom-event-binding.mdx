...
Om vi lägger till en till länk, och ändrar id till class istället, så kan vi binda samma funktion till båda länkarna, så här;

HTML:

```html
<a class="clicker" href="#">Click me!</a>
<a class="clicker" href="#">Click me too!</a>
```
...
window.onload = function() {
  let links = document.getElementsByClassName("clicker");

  for (let index = 0; index < links.length; index++) {
    links[index].addEventListener("click", myEvent);
  }
};
```
...
- event.target syftar till elementet som eventet kom ifrån.
- För att ändra bakgrundsfärg använder du .style.backgroundColor = "dinfärg";
...
<h2 style="page-break-before: always;">Övning 3</h3>
