...
For-loopar är bland den vanligaste och mest användbara iterationssatserna.
...
`i <= 5` är loopens _condition_. Loopen körs så länge detta är sant. Detta körs innan loopens statement körs.
