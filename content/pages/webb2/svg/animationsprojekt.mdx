...
**Har du inte några assets (symboler och illustration)?** Antingen skapar du några enkla symboler och illustrationer, eller så letar du online. Du kan hämta ikoner via tex Iconify-pluginen i Figma, [NounProject](https://thenounproject.com/), [IconSet](https://iconset.io/icons), eller ta någon av mina från [Fractal Symbols](http://fractalsymbols.com/)(brädspelsrelaterade).
...
För illustrationens animation ska du animera flera delar, och använda GSAP's tween-funktioner (to eller from-funktionen).
...
Följande genomgångar finns inspelade och hjälper dig med uppgiften:
...
**Deadline för uppgiften är 13 december!**
