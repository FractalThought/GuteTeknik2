...
Du kan använda [Gutegymnasiet.se](https://gutegymnasiet.se/) eller [Generic Board Game](https://ft-responsive.netlify.app/) som guide i hur du kan lägga upp ditt innehåll. [Generic Board Game](https://ft-responsive.netlify.app/) innehåller allt du behöver i termer av innehåll och funktion.
...
Din hemsida ska innehålla riktigt innehåll och du behöver skapa texter till hemsidan. Du ska alltså inte använda "dummy text" så som lorem ipsum.
...
- Förutom Media Queries och CSS Grid så bör du använda BEM-metodiken. **För högre betyg än C ska du använda BEM.**
- Du behöver bara skapa en sida (index.html), men sidan kan innehålla fler.
- Du använder antingen Visual Studio Code, eller CodePen.

## Dokumentation
Du avslutar ditt projekt med att skriva en kort dokumentation, som vanligt skriver du minst om vad som gick bra, vad som gick mindre bra, och vad du ska tänka på tills nästa gång. **Dokumentationen ska motsvara ungefär ett halvt A4 med 12pt textstorlek och vanligt radavstånd.**

<Notice>

Använder du CodePen så kan du lägga in din dokumentation i beskrivningen för din pen. Gå till Settings och i Pen Details har du möjlighet att skriva.

</Notice>

# Inlämning
Inlämning sker på SchoolSoft genom uppladdning till portfolio eller via Teams.

Du ska lämna in följande:
- Länk till din hemsida eller filerna till hemsidan
...
- [Responsiv design](https://guteteknik.netlify.app/webb2/responsiv/intro)
- [CSS Grid](https://guteteknik.netlify.app/webb2/grid/intro)
