...
I den här fasen ska du använda [CSS variabler](https://guteteknik.netlify.com/webb2/utvecklingspraxis/css-variabler) och [BEM](https://guteteknik.netlify.com/webb2/utvecklingspraxis/bem-metodiken/) för att översätta din dashboard design till HTML och CSS.
...
Förslagsvis skriver du din dokumentation i en egen sektion under din dashboard, eller på en egen sida (om du jobbar i VSCode).
